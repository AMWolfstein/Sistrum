...
import com.amwolfstein.sistrum.presentation.app.SistrumNavHost
import com.amwolfstein.sistrum.presentation.player.PlayerViewModel
import com.amwolfstein.sistrum.ui.theme.DynamicAppTheme
...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            SistrumApp(systemDynamicPrimary = systemDynamicPrimary)
        }
    }
}
...
fun SistrumApp(
    ...
    DynamicAppTheme(currentSeedColor) {
        SistrumNavHost(playerViewModel)
    }
}