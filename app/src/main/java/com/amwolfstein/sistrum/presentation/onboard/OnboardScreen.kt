...
package com.amwolfstein.sistrum.presentation.onboard
...
import com.amwolfstein.sistrum.presentation.app.LibraryViewDestination
...
fun OnboardScreen(
    ...
    Scaffold(
        ...
        Column(
            ...
            Text("Sistrum needs media permission to access music & audio on your device",
