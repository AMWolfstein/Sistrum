...
import com.amwolfstein.sistrum.presentation.app.PlaylistViewDestination
...
import com.amwolfstein.sistrum.presentation.utils.calculateBorderRadiusForGridItem

@Composable
fun PlaylistListPage(
    ...
    val allPlaylists by playlistListViewModel.allPlaylists.collectAsStateWithLifecycle()
...
fun PlaylistListItem(
    ...
    val checked = currentlyPlaying.value?.track in playlist.tracks
